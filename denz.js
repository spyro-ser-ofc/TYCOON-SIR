...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerG: 'ᴏɴʟʏ ғᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ 🥶',
				ownerB: '𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 ꪶ𝙿𝙰𝚃𝙲𝙷-𝚂𝙴𝚁ꫂ⁩',
				admin: 'ᴏɴʟʏ ғᴏʀ ᴀᴅᴍɪɴ🙂',
				Badmin: 'ᴍᴀᴋᴇ ʙᴏᴛ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴ💃ᴛᴏ ᴜsᴇ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ😴🎗️'
			}
		}
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ī.ᴀᴍ/ꪶ͢ᴘᴀᴛᴄʜꫂ⁩_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
                case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩🌹"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - 🌹"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩🌹"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩🌹"; break;
            ...
            switch(jamss){
                ...
                case 4: jamss = "ī.ᴀᴍ/ꪶ𝙿𝙰𝚃𝙲𝙷ꫂ🤤"; break;
                case 5: jamss = "ī.ᴀᴍ/ꪶ𝙿𝙰𝚃𝙲𝙷ꫂ🤤"; break;
                ...
                case 12: jamss = "ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷"; break;
                case 13: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ💘"; break;
                case 14: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🏖️"; break;
                case 15: jamss = "ī.ᴀᴍ/ꪶ𝙿𝙰𝚃𝙲𝙷ꫂ🤤"; break;
                case 16: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ😚"; break;
                case 17: jamss = "ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ🌹"; break;
                case 18: jamss = "‍ī.ᴀᴍ/ꪶ𝙿𝙰𝚃𝙲𝙷ꫂ🤤"; break;
                case 19: jamss = "ī.ᴀᴍ/ꪶ𝙿𝙰𝚃𝙲𝙷ꫂ🤤"; break;
                case 20: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ🌚"; break;
                case 21: jamss = "ɢᴏᴏᴅ ɴɪɢʜᴛ😴"; break;
                case 22: jamss = "ᴘᴏɪ ᴜʀᴀɴɢ ᴍᴡᴏɴᴜ🤤"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/917994909899?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
reply(String(e))
 ...
 {denz.sendMessage(from, dwldm(), text, {quoted: mek})}}
  if (rspndbutton) { if (rspndbutton == 'group')
 {denz.sendMessage(from, dwldm(), text, {quoted: mek})}} 
 ...
 if (rspndbutton) { if (rspndbutton == 'script')
 {denz.sendMessage(from, ownm(), text, {quoted: mek})}} 		 		
 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷ꫂ ⁩✘ ➫➬➭ ${anji}`, orderTitle: `𒈒 ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷ꫂ⁩ 𒈒➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 77777, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷ꫂ⁩ ✘ ➫➬➭ ${anju}`, orderTitle: `𒈒 ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷ꫂ⁩ 𒈒➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 27997200, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷 ✘ ➫➬➭ ${anjh}`, orderTitle: `𒈒 ī.ᴀᴍ/𝙿𝙰𝚃𝙲𝙷 𒈒➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
{buttonId:`script`,buttonText:{displayText:'𝐒𝐂𝐑𝐈𝐏𝐓🤭'},type:1}
]
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'𝐌𝐄𝐍𝐔🪀'},type:1},
{buttonId:`owner`,buttonText:{displayText:'𝐎𝐖𝐍𝐄𝐑🎀'},type:1},
{buttonId:`script`,buttonText:{displayText:'𝐒𝐂𝐑𝐈𝐏𝐓🤭'},type:1}
...
case 'help2':
        ...
        totalChat = await ds.chats.all()

        denz = await denz.prepareMessage(from, denis, location, {thumbnail: denis})

        denz = denz1.message["ephemeralMessage"] ? denz.message.ephemeralMessage : denz
...
╚༄ ${prefix}ᴀʟᴏɴᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ :https://instagram.com/𝙿𝚃𝙲𝙷_𝙻
 ╚༄
...
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
 ...
 menubutton = [{buttonId:`menu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},

 {buttonId:`credits`,buttonText:{displayText:'ᴄʀᴇᴅɪᴛ'},type:1},

 {buttonId:`owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ'},type:1}

]

 menumessage = { contentText: ` `, footerText: `${hehe}`, buttons: menubutton, headerType: 6, locationMessage: denz2.message.locationMessage}
break
case 'menu': case 'Patch':
let pi=denz["prepareMessageFromContent"](from,{
"listMessage":{
"title":"ʜɪ ʙʀᴏ ᴛʜɪs ɪs ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩ ᴍᴇɴᴜ","description":`${""}
     ʜɪ ʙʀᴏ  ${pushname}
┏━━━━━━ꪶ𝑃𝐴𝑇𝐶𝐻͢ 𝑆𝐸𝑅ꫂ⁩
┃
┗━━━━━━━━━━━━━━━✧✦✧
...
${tampilHari}
${" "}
  ➤ ʜɪ ʙʀᴏ ${pushname}    ᴄʟɪᴄᴋ ᴍᴇɴᴜ ᴡʜɪᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴋɴᴏᴡ🌚
${""}
`,"buttonText":" (ʟɪsᴛ ᴍᴇɴᴜ) ","listType":"SINGLE_SELECT","sections":[{
"title":"ʜᴇʏ ᴠʀᴏᴏ ᴛʜɪs ɪs ʙᴏᴛ ᴍᴇɴᴜ","rows":[{
"title":"group","rowId":"0"
}
...
break
	...
	teksnya = `╭───────────────𒆜
 | ʜɪ ʙʀᴏ ${pushname} ᴅᴏɴᴀᴛᴇ ꪶᴘᴀᴛᴄʜ-sᴇʀꫂ⁩ 🥂*
╰───────────────𒈒
╭───────────────𒆜
 | ᴀɴᴛʜᴀᴅᴀ ᴅᴏɴᴀᴛᴇ ᴄʜᴇʏᴀɴɴᴏ ?
 | 𒆜┤*ᴘᴀʏᴛᴍ*
 | 𒆜┤ʜᴇʏ ʙʀᴏ ᴡᴇ ᴅᴏɴᴛ ᴀᴄᴄᴇᴘᴛ ᴅᴏɴᴀᴛᴇs
 | 𒆜┤*ɢᴏᴏɢʟᴇ ᴘᴀʏ*
 | 𒆜┤ʜᴇʏ ʙʀᴏ ᴡᴇ ᴅᴏɴᴛ ᴀᴄᴄᴇᴘᴛ ᴅᴏɴᴀᴛᴇs
╰───────────────𒈒`
teks =
...
but = [
          { buttonId: `menu`, buttonText: { displayText: '𝑴𝑬𝑵𝑼🤤' }, type: 1 },
          { buttonId: `owner`, buttonText: { displayText: '𝑶𝑾𝑵𝑬𝑹🌹' }, type: 1 }
        ]
...
╰───────────────𒈒
 ...
 ꪶᴘᴀᴛᴄʜꫂ⁩💝
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 7777, "message": `${yez}`, "footerText": "©ī.ᴀᴍ/ᴘᴀᴛᴄʜꫂ⁩", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* : ꪶ͢ᴘᴀᴛᴄʜ sᴇʀ ʙᴏᴛꫂ⁩
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ꪶᴘᴀᴛᴄʜꫂ⁩
...
gbutsan = [{buttonId:`meme`,buttonText:{displayText:'𝑵𝑬𝑿𝑻 𝑴𝑬𝑴𝑬➡️'},type:1}]
mhan = await denz.prepareMessage(from, buff, image, {thumbnail: buff})
const buttonMessagessss = {
imageMessage: mhan.message.imageMessage,
contentText: `𝙱𝚘𝚜𝚜`,
footerText: '*_©ī.ᴀᴍ/ꪶᴘᴀᴛᴄʜꫂ⁩_*',
buttons: gbutsan,
headerType: 4
}
...
client.browserDescription = ['Patch','Edge','3.0']
...
break
		...
		case 'git':
		case 'sourcecode':
		anu =`╭─𒋨ᴀɴᴛʜᴀᴅᴀ sᴄʀɪᴘᴛ ᴠᴇɴᴏ ɴᴇɴᴋ🤤
└──────ᴄʜᴜɢᴀᴍ ᴘᴀʀᴀᴋᴋᴀᴛᴛᴇ🕊️🌚──────𒆜`
const buttons = [{buttonId: `jadibot`, buttonText: {displayText: '𝙱𝙴𝙲𝙾𝙼𝙴 𝙰 𝚃𝙴𝙼𝙿 𝙱𝙾𝚃🎀'}, type: 1},{buttonId: `owner`, buttonText: {displayText: '𝑶𝑾𝑵𝑬𝑹🪀'}, type: 1}]
const buttonMessage = {
    contentText: `${anu}`,
    footerText: '*𝙾𝙾𝙿𝚂 𝚂𝙾𝚁𝚁𝚈 𝙱𝚁𝙾 𝙶𝙸𝚃 𝙸𝚂 𝙽𝙾𝚃 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴 𝚈𝙾𝚄 𝙲𝙰𝙽 𝙱𝙴𝙲𝙾𝙼𝙴 𝙰 𝚃𝙴𝙼𝙿𝚁𝙾𝚁𝚈 𝙱𝙾𝚃 𝙱𝚈 𝚃𝙰𝙿𝙿𝙸𝙽𝙶 𝙱𝙴𝙲𝙾𝙼𝙴 𝙰 𝚃𝙴𝙼𝙿 𝙱𝙾𝚃🕊️💝*',
    buttons: buttons,
    headerType: 1
}
...
menu = `╔══╗╔╗─╔══╗╔╗─╔╗╔═╗  
  ...
  ╰─────────────────❋ཻུ۪۪⸙`
katalog(menu)
sendButLocation(from, `${menu}`,`𝚊𝚗𝚢 𝚍𝚘𝚞𝚋𝚝𝚜 , 𝚌𝚘𝚗𝚝𝚊𝚌𝚝 𝚘𝚠𝚗𝚎𝚛🌝💞 \n          ❏  ʙᴏᴛ ʙʏ ᴘᴀᴛᴄʜ ❏ \n\n ʙᴏᴛ ʙʏ ᴘᴀᴛᴄʜ`, {jpegThumbnail:denz.jpg}, [{buttonId:`menu`,buttonText:{displayText:'𝐌𝐄𝐍𝐔🤤'},type:1},{buttonId:`owner`,buttonText:{displayText:'𝐎𝐖𝐍𝐄𝐑🎗️'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
		break
				case 'getpp':
					anu = from
...
case 'tts':
         ...
         break
         case 'gc': case 'group':
buttonss = [{buttonId: `opengc`, buttonText: {displayText: '🎗️𝐎𝐏𝐄𝐍'}, type: 1},{buttonId: `closegc`, buttonText: {displayText: '🥶𝐂𝐋𝐎𝐒𝐄'}, type: 1}]
const bMess = {
    contentText: 'ᴏᴘᴇɴ/ᴄʟᴏsᴇ\n\nɢʀᴏᴜᴘ',
    footerText: 'sᴇʟᴇᴄᴛ ᴀɴʏ',
    buttons: buttonss,
    headerType: 1
}
...
break
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('𝙰𝙻𝚁𝙴𝙰𝙳𝚈 𝙰𝙲𝚃𝙸𝚅𝙴𝙳 𝙱𝚈 𝚃𝚈𝙲𝙾𝙾𝙽 ')
						welkom.push(from)
...
const btnbc = {
    ...
    footerText: '*_ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ ꪶᴘᴀᴛᴄʜꫂ⁩_*',
    buttons: buttonss,
    headerType: 1
}
      ...
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
           if (c === 'on'){
              autorespon = false
                    ...
                    autorespon = true
                    reply(`🌹Successfully Disable Autoresponse🌹`)
                } else if (!c) {
                    anu =`🎗️Please Choose One🎗️\n\n🎀ON: To Activate🌹\n🎀OFF: To Deactivate🌹`
const buttons = [{buttonId: 'autorespon on', buttonText: {displayText: '𝑶𝑵'}, type: 1},{buttonId: 'autorespon off', buttonText: {displayText: '𝑶𝑭𝑭'}, type: 1}]
const btnharam = {
    contentText: `${anu}`,
    footerText: '*_𝐀𝐌𝐄𝐄𝐍 𝐒𝐄𝐑_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					case 'shutdown':
					if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				reply2('𝚂𝚄𝙲𝙲𝙴𝚂𝚂 𝚂𝙷𝚄𝚃𝚃𝙸𝙽𝙶 𝙳𝙾𝚆𝙽 𝚃𝚈𝙲𝙾𝙾𝙽😴')
				await sleep(1000)
...
break
				case 'tobc':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				if (args.length < 1) return reply('𝚆𝙷𝙰𝚃 𝙸𝚂 𝚃𝙴𝚇𝚃  𝙿𝙰𝚃𝙲𝙷 𝚂𝙴𝚁🎗️?')
				var bc = body.slice(6)
					denz.updatePresence(from, Presence.composing)
					anu = await denz.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              reply('𝚃𝙷𝙸𝚂 𝙶𝚁𝙾𝚄𝙿 𝙸𝚂 𝙷𝙰𝙲𝙺𝙴𝙳 𝙱𝚈 𝚃𝚈𝙲𝙾𝙾𝙽 𝙱𝚈 𝐀𝐌𝐄𝐄𝐍')
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
              sendBug(from)
              denz.groupUpdateSubject(from, `HACKED BY PATCH`)
...
*Sɪᴢᴇ :* ${res[0].size}`
              ...
              buttons = [{buttonId: `${prefix}buttons2 ${q}`,buttonText:{displayText: `ᴠɪᴅᴇᴏ`},type:1},{buttonId:`${prefix}buttons1 ${q}`,buttonText:{displayText:'sᴏɴɢ'},type:1}]

              fs.writeFileSync(`./ytmp.jpeg`, await getBuffer(res[0].thumb))

              yt1 = await denz.prepareMessage(from, fs.readFileSync(`./ytmp.jpeg`), location, {thumbnail: fs.readFileSync(`./ytmp.jpeg`),})
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					if (err) return denz.sendMessage(from, `root @patch-Ser:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					denz.sendMessage(from, `ᴛʜɪs sᴛɪᴄᴋᴇʀ ʜᴀs ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴅᴀᴛᴀʙᴀsᴇ ᴘᴀᴛᴄʜ sᴇʀ🌚*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
					 ...
					 reply(`ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴀᴛ sᴛɪᴄᴋᴇʀ ᴘᴀᴛᴄʜ sᴇʀ🥰${body.slice(12)}`)
					} catch (err){
						console.log(err)
						reply(mess.error.api)
					}
				...
				case 'liststicker':
					...
					denz.sendMessage(from, `𝙷𝙴𝙷𝙴 𝙱𝙶𝙼 𝙰𝙳𝙳𝙴𝙳, SER 🌚🎗️`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Patch ser",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/917994909899?text=Hi Bro"}}})
	}
    }
    }
    }
