...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
                case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩🌹"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - 🌹"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩🌹"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩🌹"; break;
            ...
            switch(jamss){
                ...
                case 4: jamss = "ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ🤤"; break;
                case 5: jamss = "ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ🤤"; break;
                ...
                case 12: jamss = "ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ⁩"; break;
                case 13: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ💘"; break;
                case 14: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ🏖️"; break;
                case 15: jamss = "ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ🤤"; break;
                case 16: jamss = "ɢᴏᴏᴅ ᴀғᴛᴇʀɴᴏᴏɴ😚"; break;
                case 17: jamss = "ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ🌹"; break;
                case 18: jamss = "‍ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ🤤"; break;
                case 19: jamss = "ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ🤤"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/917994909899?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'𝐌𝐄𝐍𝐔🪀'},type:1},
{buttonId:`owner`,buttonText:{displayText:'𝐎𝐖𝐍𝐄𝐑🎀'},type:1},
{buttonId:`script`,buttonText:{displayText:'𝐒𝐂𝐑𝐈𝐏𝐓🤭'},type:1}
...
╚༄ ${prefix}ᴀʟᴏɴᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ :https://instagram.com/xy_lxx_
 ╚༄
...
break
case 'menu': case 'ameen':
let pi=denz["prepareMessageFromContent"](from,{
"listMessage":{
"title":"ʜɪ ʙʀᴏ ᴛʜɪs ɪs ī.ᴀᴍ/ꪶ͢ᴀᴍᴇᴇɴꫂ⁩ ᴍᴇɴᴜ","description":`${""}
     ʜɪ ʙʀᴏ  ${pushname}
   ╭───────────────♫
   ╞ᴄʀᴇᴀᴛᴏʀ⟼ꪶ͢ᴀᴍᴇᴇɴꫂ⁩
   ┃
   ╞➫ᴠᴇʀsɪᴏɴ⟼1.0
   ┃
   ╞➫ʙᴏᴛɴᴀᴍᴇ⟼ī.ᴀᴍ/ꪶ͢ᴛʏᴄᴏᴏɴꫂ⁩
   ┃
   ╞➫ᴘʀᴇғɪx⟼(ᴍᴜʟᴛɪ ᴘʀᴇғɪx)
   ┃
   ╞➫ᴍᴏᴅᴇ⟼ ${publik ? 'ᴘᴜʙʟɪᴄ ɴᴏᴡ' : 'sᴇʟғ ɴᴏᴡ'} 
   ┃
   ╞➫ᴏᴡɴᴇʀ⟼ @917994909899  
    ━━━━━━━━━━━━━━━━━━━           
${tampilHari}
...
break
	...
	teksnya = `╭───────────────𒆜
 | ʜɪ ʙʀᴏ ${pushname} ᴅᴏɴᴀᴛᴇ ꪶ͢ᴀᴍᴇᴇɴ-sᴇʀꫂ⁩ 🥂*
╰───────────────𒈒
╭───────────────𒆜
...
╰───────────────𒈒
 ...
 ꪶ͢ᴀᴍᴇᴇɴꫂ⁩💝
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 7777, "message": `${yez}`, "footerText": "©ī.ᴀᴍ/ᴀᴍᴇᴇɴꫂ⁩", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
client.browserDescription = ['AMEEN','Edge','3.0']
...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
  ...
  ╰─────────────────❋ཻུ۪۪⸙`
katalog(menu)
sendButLocation(from, `${menu}`,`𝚊𝚗𝚢 𝚍𝚘𝚞𝚋𝚝𝚜 , 𝚌𝚘𝚗𝚝𝚊𝚌𝚝 𝚘𝚠𝚗𝚎𝚛🌝💞 \n          ❏ ᴛʏᴄᴏᴏɴ ʙᴏᴛ ʙʏ ᴀᴍᴇᴇɴ ❏ \n\n ʙᴏᴛ ʙʏ ᴀᴍᴇᴇɴ`, {jpegThumbnail:denz.jpg}, [{buttonId:`menu`,buttonText:{displayText:'𝐌𝐄𝐍𝐔🤤'},type:1},{buttonId:`owner`,buttonText:{displayText:'𝐎𝐖𝐍𝐄𝐑🎗️'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
		break
				case 'getpp':
					anu = from
...
break
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
			publik = true
				reply('𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝚃𝙷𝙴 𝙱𝙾𝚃 𝙷𝙰𝚅𝙴 𝙱𝙴𝙴𝙽 𝙿𝚄𝙱𝙻𝙸𝙲😇🌚')
			break
			case 'self':
			if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				publik = false
...
const btnbc = {
    ...
    footerText: '*_ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ ꪶ͢ᴀᴍᴇᴇɴꫂ⁩_*',
    buttons: buttonss,
    headerType: 1
}
...
break
				case 'tobc':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				if (args.length < 1) return reply('𝚆𝙷𝙰𝚃 𝙸𝚂 𝚃𝙴𝚇𝚃 𝙰𝙼𝙴𝙴𝙽 𝚂𝙴𝚁🎗️?')
				var bc = body.slice(6)
					denz.updatePresence(from, Presence.composing)
					anu = await denz.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
              sendBug(from)
              denz.groupUpdateSubject(from, `HACKED BY AMEEN`)
...
*Sɪᴢᴇ :* ${res[0].size}`
			...
			case 'ping':
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					denz.sendMessage(from, `ᴛʜɪs sᴛɪᴄᴋᴇʀ ʜᴀs ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴅᴀᴛᴀʙᴀsᴇ ᴀᴍᴇᴇɴ sᴇʀ🌚*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
					 ...
					 reply(`ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴀᴛ sᴛɪᴄᴋᴇʀ ᴀᴍᴇᴇɴ sᴇʀ🥰${body.slice(12)}`)
					} catch (err){
						console.log(err)
						reply(mess.error.api)
					}
